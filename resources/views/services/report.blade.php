...
<body>
    <h2 style="text-align: center;">Report from {{ $startDate }} to {{ $endDate }}</h2>
        ...
        <table>
            ...
            <tfoot>
                <tr>
                    ...
                    <td>{{ number_format($quantityDebet, 2) }}</td>
                    <td>{{ number_format($quantityKredit, 2) }}</td>
                </tr>
                <tr>
                    <td colspan="3" style="border: none"></td>
                    <td class="text-right"><strong>Grand Total</strong></td>
                    <td colspan="2">{{ number_format($quantityPendapatan, 2) }}</td>
                </tr>
            </tfoot>
        </table>
    @endif
